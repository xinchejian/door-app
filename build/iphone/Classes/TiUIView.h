...
/**
 Base class for all XinCheJianDoor views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the XinCheJianDoor view hierarchy (such as wrapped iOS UIViews) was touched.
