 ...
 * Copyright (c) 2009-2011 by XinCheJianDoor, Inc. All Rights Reserved.
...
//@interface XinCheJianDoorObject : NSObject
//@end

@interface XinCheJianDoorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[XinCheJianDoorObject class]])
		{
			for (NSString *key in [[(XinCheJianDoorObject*)o modules] allKeys])
			{
