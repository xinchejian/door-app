...
@interface XinCheJianDoorObject : KrollCoverageObject {
#else
@interface XinCheJianDoorObject : KrollObject {
#endif
@private
...
extern NSString * XinCheJianDoor$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	XinCheJianDoorObject *_xinchejiandoor;
    KrollObject* console;
	BOOL shutdown;
