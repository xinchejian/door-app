...
//Rare exceptions to indicate a bug in the _xinchejiandoor code (Eg, function that a subclass should have implemented)
...
/**
 The base class for XinCheJianDoor proxies.
 */
