...
static NSString * const kXinCheJianDoorJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_xinchejiandoorInjection
{
	...
	[html appendString:kXinCheJianDoorJavascript];
...
{
	// attempt to make well-formed HTML and inject in our XinCheJianDoor bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _xinchejiandoorInjection]];
