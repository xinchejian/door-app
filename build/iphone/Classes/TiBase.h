...
// in simulator we redefine to format for XinCheJianDoor Developer console
...
{\
	NSString * exceptionName = [@"org.xinchejiandoor." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.xinchejiandoor";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIXinCheJianDoorNativeItemNone = -1, 
	UIXinCheJianDoorNativeItemSpinner = -2,
	UIXinCheJianDoorNativeItemProgressBar = -3,
	
	UIXinCheJianDoorNativeItemSlider = -4,
	UIXinCheJianDoorNativeItemSwitch = -5,
	UIXinCheJianDoorNativeItemMultiButton = -6,
	UIXinCheJianDoorNativeItemSegmented = -7,
	
	UIXinCheJianDoorNativeItemTextView = -8,
	UIXinCheJianDoorNativeItemTextField = -9,
	UIXinCheJianDoorNativeItemSearchBar = -10,
	
	UIXinCheJianDoorNativeItemPicker = -11,
	UIXinCheJianDoorNativeItemDatePicker = -12,
	
	UIXinCheJianDoorNativeItemInfoLight = -13,
	UIXinCheJianDoorNativeItemInfoDark = -14,
	
	UIXinCheJianDoorNativeItemDisclosure = -15,
	
	UIXinCheJianDoorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all XinCheJianDoor instances of
